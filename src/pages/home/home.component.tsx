				...
				<div className='flex  items-center gap-10 md:mb-10 md:pt-24 lg:pt-32'>
					<div
						...
						<h1 className='text-lg font-bold leading-snug md:text-2xl'>
							<i>Hello</i>,👋 I'm Rizaldy
						</h1>
						<h2 className='text-xl font-bold md:text-3xl'>
							Software Developer
						</h2>
						<p className='mt-5 text-[10px] font-medium  tracking-[1.3px] md:text-base'>
						I spent most of my time playing with code for 3 years, My role was in Web Development, comes with Front-End as well as Back-End. I use TypeScript, React and Next JS to build Frontend and NodeJS with MySQL relational database 
						</p>
					...
					<div
						...
						/>
						<a
							href='https://drive.google.com/file/d/11mnSx_e1XrV4vF-4uzHFIl5C7YZ-zkv9/view?usp=drive_link'
							target='_blank'
